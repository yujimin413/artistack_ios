//
//  ProfilePhotoSetViewController.swift
//  Artistack
//
...
protocol callProfilePhotoSetVC {
    func profileImageSet(data: UIImage, imageUrl: URL)
}

class ProfilePhotoSetViewController: UIViewController {
    @IBOutlet weak var backButton: UIButton!
    @IBOutlet weak var cameraButton: UIButton!
    @IBOutlet weak var libraryButton: UIButton!
    
    var delegate: callProfilePhotoSetVC?
    var imgUrl: URL?
//    var data: UIImage?
...
//        print("disappear")
//        delegate?.profileImageSet(data: data!)
//    }
...
extension ProfilePhotoSetViewController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
...
//                    let data=NSData(contentsOf: imgUrl as! URL)!
                ...
                delegate?.profileImageSet(data: profileImage, imageUrl: imgUrl!)
            }
        }
